...
import com.stamen.rop.SecurityManager;
import com.stamen.rop.response.ErrorResponse;
import com.stamen.rop.validation.*;
...
public class AnnotationRopServiceMethodAdapter implements RopServiceMethodAdapter {
    ...
    private BindingResult doBind(WebRequest webRequest, Class<? extends RopRequest> requestType) {
