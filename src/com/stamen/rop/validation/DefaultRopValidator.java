 ...
 * 日    期：12-2-13
 */
package com.stamen.rop.validation;

import com.stamen.rop.RopException;
import com.stamen.rop.RopRequest;
import com.stamen.rop.RopServiceContext;
import com.stamen.rop.utils.CodeGenerator;
...
public class DefaultRopValidator implements RopValidator {
    ...
    private void init() {
        ...
        String sessionCheckerImplClassName = properties.getProperty(
                "SessionChecker.implClass","com.stamen.rop.validation.DefaultSessionChecker");
        String appSecretManagerImplClassName = properties.getProperty(
                "AppSecretManager.implClass","com.stamen.rop.validation.FileBaseAppSecretManager");
        try {
    ...
    public MainError validate(RopServiceContext context) {
        //1.签名检查
        MainError mainError = checkSign(context);
        ...
        if (mainError == null) {
            ...
            mainError = validateBopRequest(ropRequest);
    ...
    private MainError checkSign(RopServiceContext context) {
        ...
        String signValue = sign(paramNames, paramSingleValueMap, getSignSecret(context.getAppKey()));
    ...
    private MainError validateBopRequest(RopRequest ropRequest) {
        if (ropRequest == null) {
