...
public class SubErrors {
    ...
    static {
        SUBERROR_MAINERROR_MAPPINGS.put(SubErrorType.ISP_SERVICE_UNAVAILABLE,
        ...
        SUBERROR_MAINERROR_MAPPINGS
                .put(SubErrorType.ISV_INVALID_PERMISSION, MainErrorType.INSUFFICIENT_ISV_PERMISSIONS);
    }
