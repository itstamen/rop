...
public class SubErrors {
    ...
    static {
        ...
        SUBERROR_MAINERROR_MAPPINGS.put(SubErrorType.ISP_PARSE_ERROR, MainErrorType.SERVICE_CURRENTLY_UNAVAILABLE);
        SUBERROR_MAINERROR_MAPPINGS.put(SubErrorType.ISP_REMOTE_CONNECTION_TIMEOUT, MainErrorType.SERVICE_CURRENTLY_UNAVAILABLE);
        SUBERROR_MAINERROR_MAPPINGS.put(SubErrorType.ISP_REMOTE_CONNECTION_ERROR, MainErrorType.SERVICE_CURRENTLY_UNAVAILABLE);
        SUBERROR_MAINERROR_MAPPINGS.put(SubErrorType.ISP_MAPPING_PARSE_ERROR, MainErrorType.INVALID_ARGUMENTS);
