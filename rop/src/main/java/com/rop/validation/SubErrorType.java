...
public enum SubErrorType {
    ...
    ISP_PARSE_ERROR,
    ISP_REMOTE_CONNECTION_TIMEOUT,
    ISP_MAPPING_PARSE_ERROR,
    ISP_UNKNOWN_ERROR,
    ...
    static {
        ...
        errorKeyMap.put(SubErrorType.ISP_PARSE_ERROR, "isp.parse-error");
        errorKeyMap.put(SubErrorType.ISP_REMOTE_CONNECTION_TIMEOUT, "isp.remote-connection-timeout");
        errorKeyMap.put(SubErrorType.ISP_MAPPING_PARSE_ERROR, "isp.mapping-parse-error");
